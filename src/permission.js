...
const whiteList = ['/user/login', '/user/register', '/user/register-result','/user/alteration','/InsertReportingInformation/InsertReportingInformationDetail'] // no redirect whitelist
const appWhiteList = [
  '/webview/info',
  '/webview/sun',
]
