    ...
    <div class="w">
      ...
      <div class="title" >
        ...
        <ul>
          ...
          <li class="test-info">命题人: {{testData.creatorName}}</li>
          ...
          <div class="topic" v-for="(topics, index) in sortedTopics" :key="index">
            ...
            <div class="topicsType" v-if="topics.topic_content.length != 0 ">
              ...
              <div class="topic-content" v-for="(t, index) in topics.topic_content" :key="index">
                ...
                <!-- 单选题 -->
                <div class="radio" v-if="t.topicType==1">
                ...
                <!-- 多选题 -->
                <div class="checkbox" v-if="t.topicType == 2">
                ...
                <!-- 判断题 -->
                <div class="TrueOrFalse" v-if="t.topicType == 3">
