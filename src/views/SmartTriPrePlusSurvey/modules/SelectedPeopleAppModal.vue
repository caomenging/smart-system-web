<template>
  <j-modal
    ...
    @cancel="handleCancel"
  >
    <selected-people-app-list ref="realList" @ok="submitCallback" :disabled="disableSubmit" />
...
import SelectedPeopleAppList from './SelectedPeopleAppList.vue'
export default {
  name: 'SelectedPeopleAppModal',
  components: { SelectedPeopleAppList },
  data() {
    return {
      title: '被访人',
      width: 800,
