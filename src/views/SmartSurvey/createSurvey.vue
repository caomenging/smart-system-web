<template>
  <div class="createTest testPaper" @click.self="edit(-1,-1)">
    <div class="w">
      ...
      <!-- 试卷信息 -->
      <div class="title">
        <el-input v-model="testData.paperName" class="testName" placeholder="请输入调查问卷标题" ></el-input>
        <el-select v-model="testData.paperType" placeholder="请选择试卷类型">
          <el-option
        ...
        <ul>
          ...
          <li class="fr">
            <el-button  size="mini" type="primary" @click="submit()">保存调查问卷</el-button>
