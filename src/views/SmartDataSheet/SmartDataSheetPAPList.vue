        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="文件名">
              <a-input placeholder="请输入文件名" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
        ...
        columns: [
          ...
          },
          {
            ...
            customRender:(dataIndex) =>{
              return <a href="http://localhost:8080/smart-system/sys/common/static/">{dataIndex}
              </a>
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         ...
         fieldList.push({type:'sel_depart',value:'departmentid',text:'上传单位'})
