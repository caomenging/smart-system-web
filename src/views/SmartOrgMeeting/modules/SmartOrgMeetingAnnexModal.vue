        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="附件文件" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="annexFilepath">
              <j-upload v-model="model.annexFilepath"  ></j-upload>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
<script>
  ...
  export default {
    name: "SmartOrgMeetingAnnexModal",
    components: {
    },
    props:{
      mainId:{
    ...
    data () {
      return {
        ...
        url: {
          add: "/SmartOrgMeeting/smartOrgMeeting/addSmartOrgMeetingAnnex",
          edit: "/SmartOrgMeeting/smartOrgMeeting/editSmartOrgMeetingAnnex",
        }
