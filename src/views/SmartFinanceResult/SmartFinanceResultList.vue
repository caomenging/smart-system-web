<template>
  <a-card :bordered="false">
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane tab="8项规定财物收支附件" key="1" >
        <SmartFinanceAnnexList :mainId="selectedMainId" />
      </a-tab-pane>
    </a-tabs>

    <smartFinanceResult-modal ref="modalForm" @ok="modalFormOk"></smartFinanceResult-modal>
  </a-card>
</template>
...
<script>
  ...
  import SmartFinanceAnnexList from './SmartFinanceAnnexList'
